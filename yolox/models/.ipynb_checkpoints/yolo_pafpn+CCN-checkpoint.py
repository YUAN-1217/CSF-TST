...
from .network_blocks import BaseConv, CSPLayer, DWConv, CCN
...
class YOLOPAFPN(nn.Module):
    ...
    def __init__(
        ...
        # Add CCN modules
        self.ccn_pan_out2 = CCN(ch=int(in_channels[0] * width))
        self.ccn_pan_out1 = CCN(ch=int(in_channels[1] * width))
        self.ccn_pan_out0 = CCN(ch=int(in_channels[2] * width))
    ...
    def forward(self, input):
        ...
        # Apply CCN after C3_p3
        pan_out2 = self.ccn_pan_out2(pan_out2)[0]

        p_out1 = self.bu_conv2(pan_out2)  # 256->256/16
        p_out1 = torch.cat([p_out1, fpn_out1], 1)  # 256->512/16
        pan_out1 = self.C3_n3(p_out1)  # 512->512/16
        # Apply CCN after C3_n3
        pan_out1 = self.ccn_pan_out1(pan_out1)[0]

        p_out0 = self.bu_conv1(pan_out1)  # 512->512/32
        p_out0 = torch.cat([p_out0, fpn_out0], 1)  # 512->1024/32
        pan_out0 = self.C3_n4(p_out0)  # 1024->1024/32
        # Apply CCN after C3_n4
        pan_out0 = self.ccn_pan_out0(pan_out0)[0]
